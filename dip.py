...
class ImageMatrix(np.ndarray):
    ...
    def padding(np_ar, kernel, extension=False):
        ...
        :param extension: bool If true, applies extension padding, applies zero padding otherwise.
    ...
    def run_kernel_loop(self, image_padded, kernel, bias=0):
        ...
        :param image_padded: ImageMatrix with adequate shape and content (see padding()).
    ...
    def apply_kernel(self, kernel, offU=0, offD=0, offL=0, offR=0, bias=0):
        ...
        image_padded = np.int16(offset.padding(kernel, extension=True))
    ...
    def apply_kernel_float(self, kernel, offU=0, offD=0, offL=0, offR=0, bias=0):
        ...
        image_padded = np.float64(offset.padding(kernel, extension=True))
    ...
    def apply_median_filter(self, kernel):
        ...
        image_padded = np.int16(self.padding(kernel, extension=True))
    ...
    def get_gx_component(self):
        ...
        image_padded = np.int32(self.padding(kernel, extension=True))
